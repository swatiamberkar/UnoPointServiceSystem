...
import com.uno.pages.DSMPage1;
import com.uno.pages.sd.SD_HomePage;
import com.uno.pages.sd.SD_LoginPage;

public class DSMTest1 extends BaseCode {
	
	SD_LoginPage sd_LoginPage;
	SD_HomePage sd_HomePage;
	DSMPage1 dsmPage1;
	
	String xlFilePath = "D:\\UnoPoint\\UnoPointServiceSystem\\src\\main\\java\\com\\uno\\excelFile\\hard.xlsx";
	...
	public void Login() throws Exception {
		...
		driver.get("https://key.intelli.uno:1243/uppmv3new/");
		...
		dsmPage1 = new DSMPage1();
				dsmPage1.applyFilter();
	...
	public void VerifyIDTextBox(String siteCode) throws Exception {
		...
		dsmPage1.updateActivity(siteCode);
